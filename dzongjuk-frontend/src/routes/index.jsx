...
import LoginPage, { NdiLoginPage, NdiRegisterPage } from '../pages/auth/LoginPage';
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route path="/ndi-register" element={isAuthenticated ? <Navigate to="/dashboard" replace /> : <NdiRegisterPage />} />
