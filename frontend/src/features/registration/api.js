...
import { mapListEnvelope, unwrapOne } from '@/lib/http';
...
const normalizeEnvelope = payload => mapListEnvelope(payload, normalizeApplication);
...
export const applicationService = {
  ...
  recordPayment: async (id, payload) => {
    ...
    return { data: normalizeApplication(unwrapOne(data)) };
  },
